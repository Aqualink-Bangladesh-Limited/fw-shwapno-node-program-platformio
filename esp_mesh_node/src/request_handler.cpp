...
uint8_t handleReadRequest(uint8_t *requestBuffer, uint8_t *responseBuffer) {
  ...
  for (uint16_t i = 0; i < registerCount; i++) {
    ...
    switch (regAddress) {
      case 0x01: value = arr[0]; break;
      case 0x02: value = arr[1]; break;
      case 0x03: value = arr[2]; break;
      case 0x04: value = arr[3]; break;
      case 0x05: value = arr[4]; break;
      case 0x21: value = temperature; break;
      case 0x22: value = humidity; break;
      case 0x23: value = (mesh_rssi * -1); break; // Invert RSSI value to make it positive
...
uint8_t handleWriteSingleRequest(uint8_t *requestBuffer, uint8_t *responseBuffer) {
  ...
  switch (startAddress) {
    case 0x01: arr[0] = value; break;
    case 0x02: arr[1] = value; break;
    case 0x03: arr[2] = value; flag = true; break;
    case 0x04: arr[3] = value; break;
    case 0x05: arr[4] = value; break;
    default:
